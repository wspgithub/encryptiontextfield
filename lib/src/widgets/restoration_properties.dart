...
/// collected.
class RestorableTextEditingController extends RestorableChangeNotifier<EncryptionTextEditingController> {
  ...
  @override
  EncryptionTextEditingController createDefaultValue() {
    return EncryptionTextEditingController.fromValue(_initialValue);
  }

  @override
  EncryptionTextEditingController fromPrimitives(Object? data) {
    return EncryptionTextEditingController(text: data! as String);
  }
